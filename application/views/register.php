...
<body>
    ...
    <section class="section-b-space pt-0">
        ...
        <div class="custom-container">
            <form class="auth-form mt-4" id="loginForm">
                ...
                <div class="form-group mt-4">
                    <label class="form-label fw-semibold dark-text">Full Name</label>
                    <input type="text" class="form-control" id="name" placeholder="Masukan Nama Lengkap" autocomplete="off" required />
                </div>

                <button type="submit" class="btn theme-btn w-100 mt-4">Daftar</button>
            </form>
            ...
            <p class="text-center"><a href="<?= site_url('login') ?>">
                    <font class="#0d6efd"><strong>Sudah punya akun?</strong></font>
                </a></p>
        </div>
    </section>
    <!-- login page end -->
    ...
    <script>
        document.getElementById('loginForm').addEventListener('submit', function(event) {
            ...
            Swal.fire({
                title: 'Registering in...',
                text: 'Please wait while we process your register.',
                icon: 'info',
            ...
            axios.post('<?= site_url('api/register') ?>', loginData)
